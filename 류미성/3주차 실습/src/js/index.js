// 오늘 얻은 인사이트
// 1. 이벤트 위임을 어떻게할 수 있는지 알게 됨
// 2. 요구사항을 전략적으로 접근해야하는지, 단계별로 세세하게 나는 것의 중요성을 알게됨
// 3. DOM 요소를 가져올때는 $를 사용해서 변수처럼 사용할 수 있음
// 4. 새로 알게된 메서드 - innerText, insertAdjacentHtml, closest, e.target
